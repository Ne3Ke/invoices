defmodule InvoiceGenerator.Accounts.User do
  use Ecto.Schema
  ...
  defp maybe_validate_unique_email(changeset, opts) do
    if Keyword.get(opts, :validate_email, true) do
      changeset
      |> unsafe_validate_unique(:email, InvoiceGenerator.Repo)
  ...
  defp maybe_validate_unique_username(changeset, opts) do
    if Keyword.get(opts, :validate_username, true) do
      changeset
      |> unsafe_validate_unique(:username, InvoiceGenerator.Repo)
  ...
  """
  def valid_password?(%InvoiceGenerator.Accounts.User{hashed_password: hashed_password}, password)
